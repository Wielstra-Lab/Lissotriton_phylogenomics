...
#SBATCH --job-name=RAxML_Lissotriton
...
cd /data1/s2321041/Lissotriton/RAxML/

/home/s2321041/standard-RAxML-8.2.12/raxmlHPC-PTHREADS-SSE3 -T 2 -f a -x 609516 -p 609516 -N 100 -m ASC_GTRGAMMA --asc-corr=lewis -O -n LissoOut.tre -s "out.phy" -w "/data1/s2321041/Lissotriton/RAxML"
